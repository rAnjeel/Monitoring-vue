<template>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">All Devices</a></li>
                    <li><a href="#">All Ports</a></li>
                    <li><a href="#">Alerts Configured</a></li>
                    <li><a href="#">PPPOE Session</a></li>
                    <li><a href="#">MONITORED PORT ALFRED</a></li>
                    <li><a href="#">PORT STATUS</a></li>
                    <li><a href="#">CENTREON HOSTS</a></li>
                    <li><a href="#">REPORTING</a></li>
                    <li><a href="#">CENTREON SERVICES</a></li>
                    <li><a href="#">IP DSLAM</a></li>
                    <li><a href="#">ZABBIX HOSTS</a></li>
                    <li><a href="#">ZABBIX INTERFACE</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="sub-navbar">
        <ul class="nav nav-tabs">
            <li><a href="#">CORE IP TELMA</a></li>
            <li class="active"><a href="#">BNI</a></li>
        </ul>
    </div>
